...
window.FANBOX_DICT = {
  ...
  '默认已跟皮肤调好终端与 Claude Code 的颜色，想自定义再点上面改': 'Defaults are already tuned per skin for the terminal and Claude Code — tap above to customize',
  '皮肤默认': 'Skin default',
  '终端还没就绪': 'Terminal not ready yet',
  '背景': 'Background',
  '正文文字': 'Body text',
  '光标': 'Cursor',
  '选中底色': 'Selection',
  '框线 / 暗淡字': 'Borders / dim text',
  '蓝 · 信息横幅': 'Blue · info banners',
  '青 · 链接路径': 'Cyan · links & paths',
  '品红 · 强调': 'Magenta · emphasis',
  '绿 · 成功新增': 'Green · success / added',
  '红 · 错误删除': 'Red · errors / deleted',
  '黄 · 警告等待': 'Yellow · warnings',
  '次要文字': 'Secondary text',
  '暗底块': 'Dark block',
  '亮红': 'Bright red',
  '亮绿': 'Bright green',
  ...
  '亮青': 'Bright cyan',
  '亮白': 'Bright white',
  '终端底色（默认跟皮肤面板）': 'Terminal background (follows the skin by default)',
  'Claude 回答、命令输出的默认色': 'Default color of Claude replies and command output',
  '鼠标选中文本的背景': 'Background of mouse-selected text',
  'Claude Code 对话框的边框、思考中的灰字': 'Claude Code dialog borders and thinking-gray text',
  '提示框、进行中状态': 'Info boxes, in-progress state',
  '文件路径、URL、命令名': 'File paths, URLs, command names',
  '特殊高亮': 'Special highlights',
  '确认框选中项、diff 新增行': 'Selected option in confirm dialogs, diff added lines',
  '报错、diff 删除行': 'Errors, diff deleted lines',
  '警告、待确认': 'Warnings, pending confirmation',
  '还原本皮肤全部默认': 'Reset all to skin defaults',
  '改动即时生效 · 每套皮肤分开记忆': 'Applies instantly · remembered per skin',
  '还原这项默认': 'Reset this one',
  '点击取色': 'Pick a color',
  '原来的颜色': 'Previous color',
};
...
window.FANBOX_DICT_RULES = [
  ...
  // v2.9.0 终端配色面板
  [/^已自定义 (\d+) 项$/, (m) => `${m[1]} customized`],
  [/^终端配色 · (.+)$/, (m) => `Terminal colors · ${m[1]}`],
  [/^亮色变体（高级）([▸▾])$/, (m) => `Bright variants (advanced) ${m[1]}`],
];
