...
<p align="center"><sub>▲ 主界面总览（默认「电子舞厅」皮肤）。<i>截图待补——见 <a href="docs/screenshots/README.md">docs/screenshots</a>。</i></sub></p>
...
<p align="center"><sub><i>▲ 皮肤切换色卡（截图待补）。</i></sub></p>
...
<p align="center"><sub><i>▲ 侧栏可增删（截图待补）。</i></sub></p>
